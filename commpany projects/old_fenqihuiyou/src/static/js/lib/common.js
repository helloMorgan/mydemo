...
// var BaseUrl = 'http://ceshi.fenqihui.com/';

// var BaseUrl = 'https://fenqihuiyou.fenqihui.com:4443/';
            ...
            'response': function (response) {
                if (response.data.result === Reset_LOGIN || response.result === Reset_LOGIN) {
                    loginTag && (function () {
                        ...
                        // let url = window.location.href = getAbsolutePath() + '/fenqihuiyouwap/pages/account/user_login.html';
...
function getToken() {
    return localStorage.getItem('fqhy_token');
}
...
function toMine() {
    ...
    if (getToken()) {
        go_page('../../pages/account/user_personal.html')
    } else {
...
//===================weChat====================
var wx_share_title = '分期惠游';
var wx_share_desc = '先旅行后付款，让旅行快乐无忧';
var wx_share_link = 'https://fenqihuiyou.fenqihui.com';
var wx_share_imgUrl = 'https://fenqihuiyou.fenqihui.com/static/bitmap/https://fenqihuiyou.fenqihui.com/static/bitmap/travel/weixin_share.pngtravel/weixin_share.png';
// var baseUrl = "http://ceshi.fenqihui.com/";
// var baseUrl = "https://fenqihuiyou.fenqihui.com:4443/";
//生产环境
var baseUrl = "http://ceshi.fenqihui.com/";
