...
controllerFunc('ngScope', 'ngController', function ($scope, $http, $timeout, $q) {
        ...
        class UploadCd {
            ...
            constructor() {
                ...
                //点击进行微信摄像头调用 进行头像上传
                //上传下载与上传直接下载
                // $scope.baseUrl = 'http://fenqihui.jinnuofeng.com/';
                // $scope.baseUrl = 'http://1y60698h03.51mypc.cn/ ';
                //生产
                // $scope.baseUrl = 'http://fenqihui.puhuijia.com:8888/';
                // $scope.baseUrl = 'http://fenqihuiyou.fenqihui.com:8888/';
