            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    function creatLi(imglist,imgId){
                        ...
                        that.count++;
                        li.html('<img src="data:image/jpeg;base64,'+that.compressImg +'" alt="上传图片" /><p class="travel-img-remove" onclick="uploadContractsObj.deleteImg(this)"><i class="iconfont ">&#xe63d;</i></p>');
                        imglist.prepend(li);
                    }
                    if(res.result=="0000"){
                        console.log("添加图片成功");
