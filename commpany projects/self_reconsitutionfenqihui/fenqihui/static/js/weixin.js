...
!function (a, b) {
    ...
    if (!a.jWeixin) {
        ...
        var G = !1,
            ...
            }, getLocation: function getLocation(a) {}, previewImage: function previewImage(a) {
            ...
            }, getLocalImgData: function getLocalImgData(a) {
            ...
            } }, _defineProperty(_I, "getLocation", function getLocation(a) {
            a = a || {}, c(p.getLocation, { type: a.type || "wgs84" }, function () {
                return a._complete = function (a) {
                    delete a.type;
                }, a;
            }());
        }), _defineProperty(_I, "hideOptionMenu", function hideOptionMenu(a) {
            c("hideOptionMenu", {}, a);
        }), _defineProperty(_I, "showOptionMenu", function showOptionMenu(a) {
            c("showOptionMenu", {}, a);
        }), _defineProperty(_I, "closeWindow", function closeWindow(a) {
            a = a || {}, c("closeWindow", {}, a);
        }), _defineProperty(_I, "hideMenuItems", function hideMenuItems(a) {
            c("hideMenuItems", { menuList: a.menuList }, a);
        }), _defineProperty(_I, "showMenuItems", function showMenuItems(a) {
            c("showMenuItems", { menuList: a.menuList }, a);
        }), _defineProperty(_I, "hideAllNonBaseMenuItem", function hideAllNonBaseMenuItem(a) {
            c("hideAllNonBaseMenuItem", {}, a);
        }), _defineProperty(_I, "showAllNonBaseMenuItem", function showAllNonBaseMenuItem(a) {
            c("showAllNonBaseMenuItem", {}, a);
        }), _defineProperty(_I, "scanQRCode", function scanQRCode(a) {
            a = a || {}, c("scanQRCode", {
        ...
        }), _defineProperty(_I, "openAddress", function openAddress(a) {
            c(p.openAddress, {}, function () {
                return a._complete = function (a) {
                    a = g(a);
                }, a;
            }());
        }), _defineProperty(_I, "openProductSpecificView", function openProductSpecificView(a) {
            c(p.openProductSpecificView, { pid: a.productId, view_type: a.viewType || 0, ext_info: a.extInfo }, a);
        }), _defineProperty(_I, "addCard", function addCard(a) {
        ...
        }), _defineProperty(_I, "chooseCard", function chooseCard(a) {
            c("chooseCard", {
                app_id: D.appId,
        ...
        }), _defineProperty(_I, "openCard", function openCard(a) {
            for (var b = a.cardList, d = [], e = 0, f = b.length; f > e; ++e) {
                var g = b[e],
        ...
        }), _defineProperty(_I, "consumeAndShareCard", function consumeAndShareCard(a) {
            c(p.consumeAndShareCard, { consumedCardId: a.cardId, consumedCode: a.code }, a);
        }), _defineProperty(_I, "chooseWXPay", function chooseWXPay(a) {
            c(p.chooseWXPay, f(a), a);
        }), _defineProperty(_I, "openEnterpriseRedPacket", function openEnterpriseRedPacket(a) {
            c(p.openEnterpriseRedPacket, f(a), a);
        }), _defineProperty(_I, "startSearchBeacons", function startSearchBeacons(a) {
            c(p.startSearchBeacons, { ticket: a.ticket }, a);
        }), _defineProperty(_I, "stopSearchBeacons", function stopSearchBeacons(a) {
            c(p.stopSearchBeacons, {}, a);
        }), _defineProperty(_I, "onSearchBeacons", function onSearchBeacons(a) {
            d(p.onSearchBeacons, a);
        }), _defineProperty(_I, "openEnterpriseChat", function openEnterpriseChat(a) {
                ...
                if ("IMG" == c || "VIDEO" == c || "AUDIO" == c || "SOURCE" == c) {
                    ...
                    if (e) {
                        ...
                        K[f] = !0, wx.ready(function () {
                            wx.getLocalImgData({
                                localId: d, success: function success(a) {
                                    b.src = a.localData;
                                }
                            });
                        });
