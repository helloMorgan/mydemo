...
// var BaseUrl='https://ceshi.fenqihui.com:443';
...
//生产地址
var BaseUrl = 'https://ceshi.fenqihui.com:4443/';
var OSS_IMG_URL = "http://fenqihuiyou.oss-cn-qingdao.aliyuncs.com/";
            ...
            'response': function (response) {
                if (response.data.result === Reset_LOGIN || response.result === Reset_LOGIN) {
                    ...
                    loginTag && (function () {
                        ...
                        //     android.goLogin();
                        // } else {
                        // let url = window.location.href = getAbsolutePath() + '/fenqihui/pages/account/user_login.html';
                        let url = window.location.href = getAbsolutePath() + '/fqh360/pages/account/user_login.html';
...
function goLogin() {
    // window.location.href = getAbsolutePath() + '/fenqihui/pages/account/user_login.html';
    window.location.href = getAbsolutePath() + '/fqh360/pages/account/user_login.html';
            ...
            switch (e.target.id) {
                ...
                case 'home':
                    if (!getTypeNative()) {
                        ...
                        window.location.href = getAbsolutePath() + '/fqh360/pages/recommended/recommended_index.html';
                ...
                case 'personal':
                    ...
                    if (!getTypeNative()) {
                        ...
                        window.location.href = getAbsolutePath() + '/fqh360/pages/account/user_personal.html';
...
class Dialog {
    ...
    constructor(type = DIALOG_DIALOG,
        ...
        //加载动画
            ...
            this.img.src = getAbsolutePath() + '/fqh360/static/bitmap/travel/loadgif.gif';
