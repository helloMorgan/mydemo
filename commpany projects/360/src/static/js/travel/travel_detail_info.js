        ...
        $http({
            ...
            if(response.data.totalCount>10){
               console.log(response.data.totalCount);
                switch (type){
                    case '2':
                        if(type2){ getInfo(type,response.data.totalCount);type2=false;return; }
                        break;
                    case '3':
                        if(type3){getInfo(type,response.data.totalCount); type3=false;return;}
                       break;
                    case '4':
                        if(type4){getInfo(type,response.data.totalCount); type4=false;return;}
                       break;
               }
